...
chmod u+x 1-index.html && git add --chmod=+x 1-index.html && git commit -m 'Task 01 an HTML page that displays a header and a footer by using CSS files (same as 1-index.html) 1-index.html' && git push
