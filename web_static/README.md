...
chmod u+x 3-index.html && git add --chmod=+x 3-index.html && git commit -m 'Task 02 an HTML page that displays a header and a footer by using CSS files (same as 1-index.html) 3-index.html'
 && git push

touch 3-index.html && git add . && git commit -m 3-index.html
