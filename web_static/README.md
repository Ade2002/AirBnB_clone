...
chmod u+x 5-index.html && git add --chmod=+x 5-index.html && git commit -m 'Task 03 an HTML page that displays a header, footer and a filters box with a search button. 5-index.html'
 && git push

touch 5-index.html && git add . && git commit -m 5-index.html
