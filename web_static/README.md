...
chmod u+x 1-index.html && git add --chmod=+x 1-index.html && git commit -m 'Task 01 an HTML page that displays a header and a footer by using the style tag in the head tag (same as 0-index.html) 1-index.html' && git push

touch 1-index.html && git add . && git commit -m 1-index.html
