...
chmod u+x 4-filters.css && git add --chmod=+x 4-filters.css && git commit -m 'Task 03 an HTML page that displays a header, footer and a filters box with a search button. 4-filters.css'
 && git push

touch 4-filters.css && git add . && git commit -m 4-filters.css
