...
chmod u+x 7-places.css && git add --chmod=+x 7-places.css && git commit -m 'Task 07 an HTML page that displays a header, footer, a filters box with dropdown and results. 7-places.css'
 && git push

touch 7-places.css && git add . && git commit -m 7-places.css
