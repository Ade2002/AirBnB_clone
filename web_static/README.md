...
chmod u+x 4-index.html && git add --chmod=+x 4-index.html && git commit -m 'Task 03 an HTML page that displays a header, footer and a filters box with a search button. 4-index.html'
 && git push
